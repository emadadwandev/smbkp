...
import 'core/services/support_service.dart' as _i540;
import 'core/services/tracking_service.dart' as _i425;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i425.TrackingService>(
        () => _i425.TrackingService(gh<_i460.SharedPreferences>()));
    ...
    gh.lazySingleton<_i630.AuthService>(() => _i630.AuthService(
          gh<_i871.ApiClient>(),
    ...
    gh.factory<_i214.ScoutProfileBloc>(() => _i214.ScoutProfileBloc(
    ...
    gh.lazySingleton<_i540.SupportService>(
        () => _i540.SupportService(gh<_i871.ApiClient>()));
    ...
    gh.factory<_i1025.UpdatePlayerMatchStatUseCase>(() =>
        _i1025.UpdatePlayerMatchStatUseCase(gh<_i557.PlayerMatchRepository>()));
    ...
    gh.factory<_i1042.PlayerMatchStatsBloc>(() => _i1042.PlayerMatchStatsBloc(
          ...
          updatePlayerMatchStatUseCase:
              gh<_i1025.UpdatePlayerMatchStatUseCase>(),
          deletePlayerMatchStatUseCase:
              gh<_i315.DeletePlayerMatchStatUseCase>(),
        ));
    ...
    gh.lazySingleton<_i1041.DeleteVideoUseCase>(
        () => _i1041.DeleteVideoUseCase(gh<_i315.PlayerProfileRepository>()));
    ...
    gh.factory<_i882.CoachProfileBloc>(() => _i882.CoachProfileBloc(
    ...
    gh.factory<_i1002.PlayerProfileBloc>(() => _i1002.PlayerProfileBloc(
          ...
          deleteVideoUseCase: gh<_i1041.DeleteVideoUseCase>(),

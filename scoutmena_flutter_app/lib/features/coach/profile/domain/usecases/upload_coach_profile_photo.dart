...
/// Uploads or updates coach profile photo
@injectable
class UploadCoachProfilePhoto {
  final CoachProfileRepository repository;

  UploadCoachProfilePhoto(this.repository);

  /// Execute the use case
  /// Validates photo file and uploads to server
  Future<CoachProfileEntity> call(File photo) async {
    // Validate photo
